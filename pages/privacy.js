...
import privacy0 from "../assets/images/privacy.png";
          ...
          <header>
            ...
            <ul className=" list-disc ml-10">
              ...
              <li className=" border-b py-4 text-sm">
                ...
                <a className=" " href="https://www.id5.io/privacy-policy">
                  https://www.id5.io/privacy-policy
                </a>
              </li>
              <li className=" border-b py-4 text-sm">
                Criteo’s privacy terms, which can be accessed here:{" "}
                <a className=" " href="https://www.criteo.com/privacy/">
            ...
            <ul className="static-list list-disc ml-10">
              <li className=" border-b py-4 text-sm">
                Essential cookies: these cookies are essential to the provision
                of our Website.
              </li>
              <li className=" border-b py-4 text-sm">
                {
              ...
              <li className=" border-b py-4 text-sm">
                ...
                statistical and analytical usage to help up analyze website
                usage.
              </li>
              <li className=" border-b py-4 text-sm">
                {
            ...
            <p className=" text-sm  text-justify">
              ...
              <a className=" " href="http://www.allaboutcookies.org/">
            ...
            <ul className="static-list list list-disc ml-10">
              <li className=" border-b py-4 text-sm">
                Administer our Website, including troubleshooting, and
            ...
            <p className=" text-sm  text-justify">
              All data collected through our Website is stored on servers
              located in the United States. Our servers are certified under the
              EU-US Privacy Shield.
            </p>
            <p className=" text-sm  text-justify">
              IP address and user agent string data from all visitors is stored
              in rotating log files on Amazon servers for up to 7 days. All of
              our employees, agents and partners are committed to keeping your
              data confidential.
            </p>
            <p className=" text-sm  text-justify">
              We have reviewed our partners privacy policies to ensure that they
              comply with similar policies in order to ensure your data
              security.
            </p>
            ...
            <p className=" text-sm  text-justify">
              We comply with the IAB Europe Transparency &amp; Consent
              Framework.
            </p>
            <p className=" text-sm  text-justify">
              {" "}
              You can withdraw consent at any time. Withdrawing consent may
              impede your ability to access certain services and will not allow
              us to provide the personalized Website experience.
            </p>
            ...
            <p className=" text-sm  text-justify">
              ...
              alteration, unauthorized access or disclosure of any personal
              data, we will take all reasonable precautions to protect your data
            ...
            <p className=" text-sm  text-justify">
              You have the right to request information regarding the data we
              have on file for you, to request correction and/or deletions of
            ...
            <p className=" text-sm  text-justify">
              This Website does not target people below the age of 16. By
              visiting this Website. You hereby warrant that you are 16 years of
              age or older or are visiting the Website under parental
              supervision.
            </p>
            ...
            <p className=" text-sm  text-justify">
              Whenever we change our privacy policy, we will post those changes
              to this Privacy Policy page, and other places we deem appropriate,
              so our users are always aware of what information we collect, how
