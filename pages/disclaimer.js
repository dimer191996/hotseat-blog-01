      ...
      <div className="  flex flex-row-reverse justify-center mt-20 md:mt-12 mb-28">
        <div class=" prose has-dropcap prose-xl   lg:prose-xl   prose-a:text-red-800 ">
          ...
          <p className="   text-sm  text-justify">
            The information provided by <b className="">BwCode</b> (“Company”,
            “we”, “our”, “us”) on <b>https://www.hotseatmag.com/</b> (the
          ...
          <p className="    text-sm  text-justify">
            ...
            created using <a href="https://policymaker.io/">PolicyMaker.io</a>,
          ...
          <p className="   flex justify-center items-center text-sm  text-justify">
            Content published on https://www.hotseatmag.com/ is intended to be
          ...
          <p className="   flex justify-center items-center text-sm  text-justify">
            ...
            BwCode is not responsible for any errors or omissions or for the
          ...
          <p className="   flex justify-center items-center text-sm  text-justify">
            In no event will BwCode, its related partnerships or corporations,
          ...
          <p className="   flex justify-center items-center text-sm  text-justify">
            ...
            https://www.hotseatmag.com/ are the trademarks and logos of their
          ...
          <p className=" text-sm  text-justify">
            ...
            <b>
              ...
              <Link href="/contact">Click here to Contact us directly</Link>
            </b>
            .
          </p>
        </div>
